...
NUM_CTX = int(os.environ.get("AURA_NUM_CTX", "2048"))
NUM_PREDICT = int(os.environ.get("AURA_NUM_PREDICT", "320"))
...
class Halem:
    ...
    async def run(self):
        ...
        while self.running:
            ...
            if result:
                if RICH and result.startswith("#"):
                    console.print(Markdown(result))
                elif RICH:
                    console.print(Panel(result, title="Harness", border_style="green"))
                else:
